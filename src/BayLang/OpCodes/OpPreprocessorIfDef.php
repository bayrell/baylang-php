...
class OpPreprocessorIfDef extends \BayLang\OpCodes\BaseOpCode
{
	...
	const KIND_CLASS_INIT = "class_init";
	const KIND_COMPONENT_BODY = "component_body";
	const KIND_OPERATOR = "operator";
	const KIND_COLLECTION = "collection";
	const KIND_DICT = "dict";
	...
	static function getClassName(){ return "BayLang.OpCodes.OpPreprocessorIfDef"; }
