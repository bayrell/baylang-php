...
class OpTryCatch extends \BayLang\OpCodes\BaseOpCode
{
	var $op;
	var $op_try;
	var $items;
	...
	static function serialize($rules)
	{
		...
		$rules->addType("op_try", new \BayLang\OpCodes\OpCodeType());
	}
	...
	static function getClassName(){ return "BayLang.OpCodes.OpTryCatch"; }
